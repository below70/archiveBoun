...
Tab2Page.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: Tab2Page, selectors: [["app-tab2"]], decls: 21, vars: 2, consts: [["padding", ""], ["src", "./assets/images/school.svg", 1, "logo"], ["position", "floating"], ["type", "text", "placeholder", "username@boun.edu.tr", 3, "ngModel", "ngModelChange"], ["type", "password", "placeholder", "******", 3, "ngModel", "ngModelChange"], ["lines", "none"], ["routerLink", "/tab1"], ["fill", "solid", "expand", "block", 3, "click"]], template: function Tab2Page_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function Tab2Page_Template_ion_input_ngModelChange_10_listener($event) { return ctx.username = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function Tab2Page_Template_ion_input_ngModelChange_14_listener($event) { return ctx.password = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function Tab2Page_Template_ion_button_click_19_listener() { return ctx.login(); });
