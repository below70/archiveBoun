...
Tab1Page.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: Tab1Page, selectors: [["app-tab1"]], decls: 28, vars: 3, consts: [["padding", ""], ["src", "./assets/images/school.svg", 1, "logo"], ["position", "floating"], ["type", "text", "placeholder", "username@boun.edu.tr", "color", "primary", 3, "ngModel", "ngModelChange"], ["type", "password", "placeholder", "******", 3, "ngModel", "ngModelChange"], ["lines", "none"], ["routerLink", "/tab2"], ["fill", "solid", "expand", "block", 3, "click"]], template: function Tab1Page_Template(rf, ctx) { if (rf & 1) {
