...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tabs-tabs-module"], {
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! ../tab6/tab6.module */
          "./src/app/tab6/tab6.module.ts")).then(function (m) {
  ...
  function srcAppTabsTabsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    TabsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 14,
      vars: 0,
      consts: [["slot", "bottom"], ["tab", "tab4"], ["name", "home", "color", "danger"], ["color", "primary"], ["tab", "tab5"], ["name", "chatbox", "color", "danger"], ["tab", "tab6"], ["name", "person", "color", "danger"]],
